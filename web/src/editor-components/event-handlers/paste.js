...
export function isPasteEvent(evt) {
    return evt.type === 'paste' || ((evt.metaKey || evt.ctrlKey) && evt.keyCode === KEYCODE_V)
}

export async function handlePaste({evt, selectionOffsetsArg, documentModel, historyManager, commitUpdates}) {
