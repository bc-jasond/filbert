  ...
  <React.Fragment>
    ...
    <ContentSection>
      ...
      <P>I decided that I'm not allowing myself to 'just wing it' anymore; not
        ...
        past, just GSD. But, inevitably someone, sometime has to go deep to be able to fix the hard bugs. If they
        don't have the knowledge (likely) then, that person will need to be willing and committed to attain it. "I
        don't
      ...
      <P>Teaching is the best way to identify gaps in knowledge. <ItalicText>"If you can't explain it simply, you
        don't understand
        it."</ItalicText>-<A href="https://en.wikiquote.org/wiki/Talk:Richard_Feynman#Teaching_quote">Richard
      ...
      <P>Most of the time architecture is the <ItalicText>wrong thing</ItalicText> to be working on since it's hard to
        quantify a business value. "if it ain't broke
        don't fix it." On larger projects there can be a lot of fear and uncertainty around changing code critical to
        the build
        system or core architecture. It has become 'special code' and the authors 'special engineers' sanctified by
        the organization, putting more scrutiny on any changes.
        Changing that code is risky and often requires a blind 'break and fix' approach that you can only test so much
        on a local environment.</P>
