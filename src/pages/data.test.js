export default {
  ...
  "childNodes": [
          ...
          "childNodes": [
            {
              "type": "text",
              "childNodes": [],
              "content": "Medium does image resizing, fingerprinting and probably initial (small) + deferred (full-size) image swaps.  My image is pretty small at ",
              "id": ""
            },
            {
              "type": "code",
        ...
        },
        {
          ...
          "childNodes": [
            ...
            },
            {
              "type": "text",
              "childNodes": [],
              "content": " was the next thing that came to mind.  Do a manual upload for now, get the URL and drop it in here as I write the posts.  For some reason, I just don't want to do that.  I guess I'm just weary about going full-cloud with my toy project.  It kind of defeats the purpose of building to learn.",
              "id": ""
            }
          ],
          "content": "",
        ...
        },
        {
          ...
          "childNodes": [
            ...
            },
            {
              "type": "text",
              "childNodes": [],
              "content": " Store the files in a database.  I had thought about putting them in a database but, then my friend Mitch added the idea of filesystem caching on first request and sold me.  I'm going to have a DB for my blog post content, why not just keep it all together?",
              "id": ""
            }
          ],
          "content": "",
        ...
        },
        {
          ...
          "childNodes": [
            ...
            },
            {
              "type": "text",
              "childNodes": [],
              "content": " but, setting up a DB is beyond the scope of this post.  For now, I'll just use a Medium CDN hack (open a new Medium story, add an image, grab the CDN url) and throw up my test image for layout purposes.  Let's see how that looks... 👀",
              "id": ""
            }
          ],
          "content": "",
    ...
    },
    {
      "type": "text",
      "childNodes": [],
      "content": "The high desert somewhere between Zacatecas & Monterrey, Mexico. © my dad",
      "id": ""
    },
    {
      "type": "image",
    ...
    },
    {
      "type": "text",
      "childNodes": [],
      "content": "Another blog post in the bag...",
      "id": ""
    },
    {
      "type": "image",
              ...
              "childNodes": [
                {
                  "type": "text",
                  "childNodes": [],
                  "content": "This project is experimental and of course comes without any warranty whatsoever. However, it could start a revolution in information access. ",
                  "id": ""
                },
                {
                  "type": "a",
                  "childNodes": [
                    {
                      "type": "text",
                      "childNodes": [],
                      "content": "-Tim Berners-Lee from \"WorldWideWeb wide-area hypertext app available\" (19 August 1991)",
                      "id": ""
                    }
                  ],
                  "content": "https://groups.google.com/forum/#!topic/comp.sys.next.announce/avWAjISncfw",
                  "id": ""
                },
                {
                  "type": "text",
                  "childNodes": [],
                  "content": ", the announcement of the first WWW hypertext browser on the Usenet newsgroup comp.sys.next.announce.",
                  "id": ""
                }
              ],
              "content": "",
