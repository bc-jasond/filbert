...
describe("DocumentModel", () => {
  test("init", () => {
    ...
    const placeholderTitle = DocumentModel.getFirstNode(documentModel.nodesById);
  ...
  test("mergeParagraphs", () => {
    const combinedContent = `${documentModel.getNode("621e").get('content')}${documentModel.getNode("f677").get('content')}`;
