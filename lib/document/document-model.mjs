...
import { cleanText, getMapWithId, reviver } from 'filbert-web/src/common/utils';
import { concatSelections } from 'filbert-web/src/editor-components/selection-helpers';
...
export function DocumentManager(postId, jsonData = null) {
  let nodesById;
