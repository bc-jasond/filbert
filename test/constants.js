module.exports = {
  EDITOR_CONTAINER_ID: 'filbert-edit-container',
  INSERT_SECTION_MENU_ID: 'insert-section-menu',
  INSERT_SECTION_MENU_BUTTON_ID: 'insert-section-menu-button',
  INSERT_SECTION_MENU_CONTAINER_ID: 'insert-section-menu-container',
  INSERT_SECTION_MENU_ITEM_ID_PREFIX: 'insert-section-menu-item-',
